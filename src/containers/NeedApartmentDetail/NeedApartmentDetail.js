            ...
            <div className="topCardBg">
              {
                receptionWait && receptionWait.map((receptionWaitItem) => {
                  return (
                    <div key={receptionWaitItem._id} className={'list clearfix ' + styles.needApartListCon}>
                      <div className="left">
                        <header>
                        {
            ...
            <div className="topCardBg">
              {
                reception && reception.map((receptionItem) => {
                  return (
                    <div key={receptionItem._id} className={'list clearfix ' + styles.needApartListCon}>
                      <div className="left">
                        <header>
                        {
            ...
            <div className="topCardBg">
              {
                completed && completed.map((completedItem) => {
                  return (
                    <div key={completedItem._id} className={'list clearfix ' + styles.needApartListCon}>
                      <div className="left">
                        <header>
                        {
